    ...
    def template_hash
      {
          ...
          'code_repo_url' => { description: '源码私有源 Git 地址', default: 'https://github.com:su350380433/example_spec_source.git' },
          'binary_repo_url' => { description: '二进制私有源 Git 地址', default: 'https://github.com:su350380433/example_spec_bin_dev.git' },
